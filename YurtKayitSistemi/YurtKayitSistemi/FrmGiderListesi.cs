...
namespace YurtKayitSistemi
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'yurtKayitDBDataSet5.Giderler' table. You can move, or remove it, as needed.
            this.giderlerTableAdapter.Fill(this.yurtKayitDBDataSet5.Giderler);
