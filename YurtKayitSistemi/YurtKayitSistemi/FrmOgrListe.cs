...
namespace YurtKayitSistemi
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'yurtKayitDBDataSet4.Ogrenci' table. You can move, or remove it, as needed.
            this.ogrenciTableAdapter.Fill(this.yurtKayitDBDataSet4.Ogrenci);
